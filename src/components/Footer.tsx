    ...
    <footer className="bg-accent-dark text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-blue-100 leading-relaxed">
              Czarter jachtu Sasanka 660 SN na Zalewie Sulejowskim. Barkowice Mokre, woj. łódzkie.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-blue-100">
              <li className="flex items-center gap-2">
                ...
                <span>503 943 226</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 shrink-0" />
                <span>bezulski@gmail.com</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 shrink-0 mt-0.5" />
                <span>Barkowice Mokre<br />woj. łódzkie, Zalew Sulejowski</span>
                <span className="ml-1">Port na Cyplu</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-blue-900 mt-8 pt-8 text-center text-xs text-blue-200">
          &copy; {new Date().getFullYear()} Sasanka Sailing. Wszelkie prawa zastrzeżone.
        </div>
      </div>
    </footer>
  );
